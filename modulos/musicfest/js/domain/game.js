...
export const defaultSession=()=>({code:'DEMO',name:'MusicFest',mode:'sequential',state:'lobby',activeDayIndex:0,revision:1,days,artistIds:[],updatedAt:new Date().toISOString()});
